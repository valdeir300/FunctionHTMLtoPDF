...
namespace Contoso.Core.LargeFileUpload
{
    ...
    public class FileUploadService
    {
        ...
        /// <returns></returns>
        public Microsoft.SharePoint.Client.File UploadFileSlicePerSlice(ClientContext ctx, string libraryName, Microsoft.SharePoint.Client.File file, int fileChunkSizeInMB = 3)
        {
            // Each sliced upload requires a unique id
            Guid uploadId = Guid.NewGuid();

            // Get the name of the file
            string uniqueFileName = Path.GetFileName(file.Name);
